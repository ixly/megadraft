...
var BlockButton = function (_Component) {
  ...
  _createClass(BlockButton, [{
    ...
    value: function onChange(e) {
      e.preventDefault();
      var file = document.getElementById("megapdraft-file-hidden-input").files[0];
      var self = this;
      ...
      if (file) {
        ...
        $.ajax({
          ...
          success: function success(response) {
            ...
            var data = { src: src, type: "image", display: "medium" };
            self.props.onChange((0, _insertDataBlock2.default)(self.props.editorState, data));
          }
        });
      }
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.submitFileUrl && _react2.default.createElement("input", { type: "file", id: "megapdraft-file-hidden-input", style: { 'display': 'none' }, onChange: this.onChange }),
